Right click anywhere for the context menu or use the burger icon (hidden when Streamdog is not focused).

Streamdog is fully customizable by editing the png files in the skins folder.
